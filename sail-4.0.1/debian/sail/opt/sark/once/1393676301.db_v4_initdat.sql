BEGIN TRANSACTION;
INSERT OR IGNORE INTO User(pkey,cluster,email,readonly,selection) values ('admin','default','admin@myco.com','NO','all');
INSERT OR IGNORE INTO Cluster(pkey,abstimeout,chanmax,include,localarea,localdplan,oclo,operator) values ('default','14400','30','ALL',NULL,NULL,'OPEN','System Operator');

...
//
	...
	$sql = "select ABSTIMEOUT,ALLOWHASHXFER,BLINDBUSY,BOUNCEALERT,CALLRECORD1,EXTLEN" .
			   ...
			   ",RINGDELAY,SYSOP,SYSPASS,SPYPASS,VOIPMAX,VOICEINSTR,ASTDLIM,MAXIN" .
...
;
        ...
        exten => _*67[*8]XXXX,1,agi(sarkhpe,\${EXTEN},,)		; ChanSpy (Whisper)
        exten => _*67[*8]XXX,1,agi(sarkhpe,\${EXTEN},,)		; ChanSpy (Whisper)        
...
;
		...
		exten => _*24[*8]XXX,1,Authenticate(\${SYSPASS})
		exten => _*24[*8]XXX,n,agi(kwakeup,EXT\${EXTEN:4})
		exten => _*24[*8]XXXX,1,Authenticate(\${SYSPASS})
		exten => _*24[*8]XXXX,n,agi(kwakeup,EXT\${EXTEN:4})

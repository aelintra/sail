...
*/
	...
	echo '<input type="text" name="pkey" id="pkey" size="20"   />' . PHP_EOL;
	...
	echo '<input type="text" name="desc" id="desc"   />' . PHP_EOL;
	$this->myPanel->aLabelFor('dialplan');
	echo '<input type="text" name="dialplan" id="dialplan"   />' . PHP_EOL;
...
private function showEdit($key=False) {
	...
	$this->myPanel->aLabelFor('routedesc');
	echo '<input type="text" name="desc" id="desc size="20" value="' . $res['desc'] . '"   />' . PHP_EOL;
	$this->myPanel->aLabelFor('dialplan');
	echo '<input type="text" name="dialplan" id="dialplan"  size="20" value="' . $res['dialplan'] . '"   />' . PHP_EOL;

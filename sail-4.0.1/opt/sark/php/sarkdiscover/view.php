 ...
 */ 
	...
	$nmapcmd= array(
	"nmap -sP $cidr | grep -v Host | grep -v '$myip' | awk '/Nmap scan/ {printf \$0 \" \"; getline; print $0}' | grep -i 'Snom\|Panasonic\|Yealink\|Polycom\|Cisco\|Gigaset\|Aastra\|Grandstream' > /tmp/netfile",

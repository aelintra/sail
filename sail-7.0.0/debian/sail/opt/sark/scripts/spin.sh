...
/usr/bin/zip -r /opt/sark/bkup/sarkbak.`date +%s`.zip /opt/sark/db/sark.db $sysroot/asterisk/sarksounds /var/spool/asterisk/voicemail /etc/asterisk /etc/shorewall /tmp/sark.local.ldif  >/dev/null 2>&1

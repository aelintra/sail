...
<!-- ** ** ** ** ** Part for the research ** ** ** ** ** -->
	...
	<INPUT TYPE="hidden" NAME="current_page" value=0>	
		<table class="bar-status" width="75%" border="0" cellspacing="1" cellpadding="2" align="center">
			<tbody><tr>
        		<td class="bar-search" align="left" bgcolor="#000">
      			...
      			<td class="bar-search" align="left" bgcolor="#999999">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#999999"><tr><td>
	  				<input type="checkbox" name="frommonth" value="true" <? if ($frommonth){ ?>checked<?}?>><font face="arial" size="1"> 
					...
					<input type="checkbox" name="tomonth" value="true" <? if ($tomonth){ ?>checked<?}?>><font face="arial" size="1"> 
        		...
        		<td align="left" bgcolor="#CC0000">
      			...
      			<td align="left" bgcolor="#CCCCCC">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#CCCCCC"><tr><td>
	  				<input type="checkbox" name="fromday" value="true" <? if ($fromday){ ?>checked<?}?>><font face="arial" size="1"> From : 
					...
					<input type="checkbox" name="today" value="true" <? if ($today){ ?>checked<?}?>><font face="arial" size="1"> To : 
			...
			<tr>
				...
				<td class="bar-search" align="center" bgcolor="#999999"><input type="radio" NAME="dsttype" value="1" <?if((!isset($dsttype))||($dsttype==1)){?>checked<?}?>><font face="arial" size="1">Exact</td>
				<td class="bar-search" align="center" bgcolor="#999999"><input type="radio" NAME="dsttype" value="2" <?if($dsttype==2){?>checked<?}?>><font face="arial" size="1">Begins with</td>
				<td class="bar-search" align="center" bgcolor="#999999"><input type="radio" NAME="dsttype" value="3" <?if($dsttype==3){?>checked<?}?>><font face="arial" size="1">Contains</td>
				<td class="bar-search" align="center" bgcolor="#999999"><input type="radio" NAME="dsttype" value="4" <?if($dsttype==4){?>checked<?}?>><font face="arial" size="1">Ends with</td>
				</tr></table></td>
			</tr>			
			<tr>
				<td align="left" bgcolor="#CC0000">					
				...
				<td class="bar-search" align="center" bgcolor="#CCCCCC"><input type="radio" NAME="sourcetype" value="1" <?if((!isset($sourcetype))||($sourcetype==1)){?>checked<?}?>><font face="arial" size = "1">Exact</td>
				<td class="bar-search" align="center" bgcolor="#CCCCCC"><input type="radio" NAME="sourcetype" value="2" <?if($sourcetype==2){?>checked<?}?>><font face="arial" size="1">Begins with</td>
				<td class="bar-search" align="center" bgcolor="#CCCCCC"><input type="radio" NAME="sourcetype" value="3" <?if($sourcetype==3){?>checked<?}?>><font face="arial" size="1">Contains</td>
				<td class="bar-search" align="center" bgcolor="#CCCCCC"><input type="radio" NAME="sourcetype" value="4" <?if($sourcetype==4){?>checked<?}?>><font face="arial" size="1">Ends with</td>
				</tr></table></td>
			</tr>
			<tr>
				<td class="bar-search" align="left" bgcolor="#000">				
				...
				<td class="bar-search" align="center" bgcolor="#999999"><input type="radio" NAME="clidtype" value="1" <?if((!isset($clidtype))||($clidtype==1)){?>checked<?}?>><font face="arial" size="1">Exact</td>
				<td class="bar-search" align="center" bgcolor="#999999"><input type="radio" NAME="clidtype" value="2" <?if($clidtype==2){?>checked<?}?>><font face="arial" size="1">Begins with</td>
				<td class="bar-search" align="center" bgcolor="#999999"><input type="radio" NAME="clidtype" value="3" <?if($clidtype==3){?>checked<?}?>><font face="arial" size="1">Contains</td>
				<td class="bar-search" align="center" bgcolor="#999999"><input type="radio" NAME="clidtype" value="4" <?if($clidtype==4){?>checked<?}?>><font face="arial" size="1">Ends with</td>
				</tr></table></td>
			</tr>
			<tr>
				<td align="left" bgcolor="#CC0000">					
				...
				<td class="bar-search" align="center" bgcolor="#CCCCCC"><input type="radio" NAME="userfieldtype" value="1" <?if((!isset($userfieldtype))||($userfieldtype==1)){?>checked<?}?>><font face="arial" size="1">Exact</td>
				<td class="bar-search" align="center" bgcolor="#CCCCCC"><input type="radio" NAME="userfieldtype" value="2" <?if($userfieldtype==2){?>checked<?}?>><font face="arial" size="1">Begins with</td>
				<td class="bar-search" align="center" bgcolor="#CCCCCC"><input type="radio" NAME="userfieldtype" value="3" <?if($userfieldtype==3){?>checked<?}?>><font face="arial" size="1">Contains</td>
				<td class="bar-search" align="center" bgcolor="#CCCCCC"><input type="radio" NAME="userfieldtype" value="4" <?if($userfieldtype==4){?>checked<?}?>><font face="arial" size="1">Ends with</td>
				</tr></table></td>
			</tr>
			<tr>
				<td class="bar-search" align="left" bgcolor="#000">				
				...
				<td class="bar-search" align="center" bgcolor="#999999"><input type="radio" NAME="accountcodetype" value="1" <?if((!isset($accountcodetype))||($accountcodetype==1)){?>checked<?}?>><font face="arial" size="1">Exact</td>
				<td class="bar-search" align="center" bgcolor="#999999"><input type="radio" NAME="accountcodetype" value="2" <?if($accountcodetype==2){?>checked<?}?>><font face="arial" size="1">Begins with</td>
				<td class="bar-search" align="center" bgcolor="#999999"><input type="radio" NAME="accountcodetype" value="3" <?if($accountcodetype==3){?>checked<?}?>><font face="arial" size="1">Contains</td>
				<td class="bar-search" align="center" bgcolor="#999999"><input type="radio" NAME="accountcodetype" value="4" <?if($accountcodetype==4){?>checked<?}?>><font face="arial" size="1">Ends with</td>
				</tr></table></td>
			</tr>			
			<tr>
			<td align="left" bgcolor="#CC0000">					
			...
			<tr>
				...
				<td>&nbsp;&nbsp;<INPUT TYPE="text" NAME="duration1" size="4" value="<?=$duration1?>"></td>
				<td class="bar-search" align="center" bgcolor="#999999"><input type="radio" NAME="duration1type" value="4" <?if($duration1type==4){?>checked<?}?>><font face="arial" size="1">&gt;</td>
				<td class="bar-search" align="center" bgcolor="#999999"><input type="radio" NAME="duration1type" value="5" <?if($duration1type==5){?>checked<?}?>><font face="arial" size="1">&gt;=</td>
				<td class="bar-search" align="center" bgcolor="#999999"><input type="radio" NAME="duration1type" value="1" <?if((!isset($duration1type))||($duration1type==1)){?>checked<?}?>><font face="arial" size="1">=</td>
				<td class="bar-search" align="center" bgcolor="#999999"><input type="radio" NAME="duration1type" value="2" <?if($duration1type==2){?>checked<?}?>><font face="arial" size="1">&lt;=</td>
				<td class="bar-search" align="center" bgcolor="#999999"><input type="radio" NAME="duration1type" value="3" <?if($duration1type==3){?>checked<?}?>><font face="arial" size="1">&lt;</td>	
				<td width="5%" class="bar-search" align="center" bgcolor="#999999"></td>
				
				<td>&nbsp;&nbsp;<INPUT TYPE="text" NAME="duration2" size="4" value="<?=$duration2?>"></td>			
				<td class="bar-search" align="center" bgcolor="#999999"><input type="radio" NAME="duration2type" value="4" <?if($duration2type==4){?>checked<?}?>><font face="arial" size="1">&gt;</td>
				<td class="bar-search" align="center" bgcolor="#999999"><input type="radio" NAME="duration2type" value="5" <?if($duration2type==5){?>checked<?}?>><font face="arial" size="1">&gt;=</td>								
				<td class="bar-search" align="center" bgcolor="#999999"><input type="radio" NAME="duration2type" value="2" <?if($duration2type==1){?>checked<?}?>><font face="arial" size="1">&lt;=</td>
				<td class="bar-search" align="center" bgcolor="#999999"><input type="radio" NAME="duration2type" value="3" <?if($duration2type==3){?>checked<?}?>><font face="arial" size="1">&lt;</td>	
				</tr></table>
				</td>
			</tr>	
			...
			<tr>
        		<td class="bar-search" align="left" bgcolor="#CC0000"> </td>

				<td class="bar-search" align="center" bgcolor="#CCCCCC">
...
<TR bgcolor="#ffffff"> 
          <TD bgColor=#999999 height=16 style="PADDING-LEFT: 5px; PADDING-RIGHT: 3px"> 
...
<TBODY>
                <TR bgColor=#999999> 
                  ...
                  <TD width="<?=$FG_TABLE_COL[$i][2]?>" align=middle class="tableBody" style="PADDING-BOTTOM: 2px; PADDING-LEFT: 2px; PADDING-RIGHT: 2px; PADDING-TOP: 2px"> 
                    ...
                    <a href="<? echo $PHP_SELF."?s=1&t=$t&stitle=$stitle&atmenu=$atmenu&current_page=$current_page&order=".$FG_TABLE_COL[$i][1]."&sens="; if ($sens=="ASC"){echo"DESC";}else{echo"ASC";} 
        ...
        <TR bgcolor="#ffffff"> 
          <TD bgColor=#CCCCCC height=16 style="PADDING-LEFT: 5px; PADDING-RIGHT: 3px"> 
			<TABLE border=0 cellPadding=0 cellSpacing=0 width="100%">
              <TBODY>
                <TR> 
                  <TD align="right"><SPAN style="COLOR: #ffffff; FONT-SIZE: 11px"><B> 
                    <?if ($current_page>0){?>
                    <img src="images/fleche-g.gif" width="5" height="10"> <a href="<?=$PHP_SELF?>?s=1&t=<?=$t?>&order=<?=$order?>&sens=<?=$sens?>&current_page=<? echo ($current_page-1)?><? if (!is_null($letter) && ($letter!="")){ echo "&letter=$letter";} 
                    ...
                    - <a href="<?=$PHP_SELF?>?s=1&t=<?=$t?>&order=<?=$order?>&sens=<?=$sens?>&current_page=<? echo ($current_page+1)?><? if (!is_null($letter) && ($letter!="")){ echo "&letter=$letter";} 
					echo "&posted=$posted&Period=$Period&frommonth=$frommonth&fromstatsmonth=$fromstatsmonth&tomonth=$tomonth&tostatsmonth=$tostatsmonth&fromday=$fromday&fromstatsday_sday=$fromstatsday_sday&fromstatsmonth_sday=$fromstatsmonth_sday&today=$today&tostatsday_sday=$tostatsday_sday&tostatsmonth_sday=$tostatsmonth_sday&dsttype=$dsttype&sourcetype=$sourcetype&clidtype=$clidtype&channel=$channel&resulttype=$resulttype&dst=$dst&src=$src&clid=$clid&channel=$channel&resulttype=$resulttype&dst=$dst&src=$src&clid=$clid&userfieldtype=$userfieldtype&userfield=$userfield&accountcodetype=$accountcodetype&accountcode=$accountcode&duration1=$duration1&duration1type=$duration1type&duration2=$duration2&duration2type=$duration2type";?>"> 
...
<tbody><tr><td bgcolor="#000000">			
	...
	?>
        ...
        <td bgcolor="<?=$FG_TABLE_ALTERNATE_ROW_COLOR[$i]?>" align="right" nowrap="nowrap"><font face="verdana" color="#000000" size="1"><?=$data[2]?></font></td>

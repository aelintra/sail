...
private function showMain() {
	...
	$sysloghd = file("/var/log/syslog") or die("Could not read file syslog!");	
	$astloghd = file("/var/log/asterisk/messages") or die("Could not read file asterisk/messages!");
	$f2bloghd = file("/var/log/fail2ban.log") or die("Could not read file fail2ban.log!");

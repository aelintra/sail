...
#
	...
	$key = 0;
	$limit = 12;
    echo '<div ><table id="viskeystable">' . PHP_EOL;
    ...
    while ($key < $limit) {
        ...
        if (preg_match("/None/",$ivrmenu[$opName])) {
        	echo '<td><a href="#key' . $tabnavkey[$key] .
        		'" id="inline"><img id="ikey' . $tabnavkey[$key] .
        		'" src="/sark-common/keys/' . $tableonkey[$key] .
                '" border=0 title = "' . $title . '"></a></td>'. PHP_EOL;
        }
        else {
        	echo '<td><a href="#key' . $tabnavkey[$key] .
        		'" id="inline"><img id="ikey' . $tabnavkey[$key] .
        		'" src="/sark-common/keys/' . $tableoffkey[$key] .
                '" border=0 title = "' . $title . '"></a></td>'. PHP_EOL;
        }

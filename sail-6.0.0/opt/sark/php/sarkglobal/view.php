 ...
 */
    ...
    $this->myPanel->aLabelFor('loglevel');
    echo '<input type="text" name="LOGLEVEL" id="LOGLEVEL" size="3"  value="' . $global['LOGLEVEL'] . '"  />' . PHP_EOL;
...
//	echo '<a href="/php/download.php?dtype=/var/log&dfile="siplog"><img src="/sark-common/icons/download.png" border=0 title = "Click to Download" ></a>' . PHP_EOL;

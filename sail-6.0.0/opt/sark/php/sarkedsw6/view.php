...
public function showForm() {
	...
	$this->myPanel->pagename = 'IPV6 Firewall';
...
/*** table rows ****/
	...
	foreach ($rec as $row ) {
		if (preg_match(" /^#|^\s/ ", $row)) {
			...
			echo '<td class="center">' . $elements[1]  . '</td>' . PHP_EOL;		
			echo '<td class="center">' . $elements[2]  . '</td>' . PHP_EOL;
			echo '<td class="center">' . $elements[3]  . '</td>' . PHP_EOL;
			echo '<td class="center">' . $elements[4]  . '</td>' . PHP_EOL;
			echo '<td class="center">' . $elements[5]  . '</td>' . PHP_EOL;
			echo '<td class="center">' . $elements[6]  . '</td>' . PHP_EOL;
			if (!empty($elements[7])) {
...
private function showNew() {
	...
	if (isset($this->message)) {
		...
		$this->myPanel->msg .= "Add New IPV6 Rule " ;
	}
	...
	echo '<input type="text" name="source" id="source" size="50" placeholder="[::/0]" />' . PHP_EOL;

...
private function showEdit() {
	...
	echo '<div class="datadivtabedit">';
   	...
   	if (array_key_exists($pkey,$readOnlyFiles)) {
		...
		echo '<textarea class="longdatabox" readonly="readonly" style = "background-color: #E8E8EE" name="astfile" id="astfile">' . $astfile . '</textarea>' . PHP_EOL;
	}
	else {
		echo '<h2>Asterisk File ' . $pkey . ' </h2>' . PHP_EOL; 	
		echo '<textarea class="longdatabox" name="astfile" id="astfile">' . $astfile . '</textarea>' . PHP_EOL;		  
	}
